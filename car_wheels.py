...
wheels = [Wheel(tpms_di['front-right'], None, 'front-right'), Wheel(tpms_di['front-left'], None, 'front-left'), 
          Wheel(tpms_di['back-right'], None, 'back-right'), Wheel(tpms_di['back-left'], None, 'back-left')]
